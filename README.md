...
Currently supported: Claude Code, Codex, OpenCode, and Pi. Future transcript support for: Gemini CLI.
...
export OPENAI_API_KEY=...                     # for Codex and Pi
...
pi --provider openai --model gpt-5-mini -p "..."  # Pi
